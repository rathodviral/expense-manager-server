...
if ($exp_data->update()) {
    die(json_encode(array("status" => true, "message" => "Yeah.. Expense/Income was updated.")));
} else {
    die(json_encode(array("status" => false, "message" => "Opps.. Unable to update Expense/Income.")));
}
